        ...
        <div class="card-body">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="api" name='api' placeholder="enter api" />
              @error('api')
                <small>{{$message}}</small>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="sae" name="sae" placeholder="Enter sae" />
              @error('sae')
                <small>{{ $message }}</small>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="sni" name='sni' placeholder="enter sni" />
              @error('sni')
                <small>{{$message}}</small>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="npt" name='npt' placeholder="enter npt" />
              @error('npt')
                <small>{{$message}}</small>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="npb" name='npb' placeholder="enter npb" />
              @error('npb')
                <small>{{$message}}</small>
              @enderror
            </div>
