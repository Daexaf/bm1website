                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="api" name="api"
                                                placeholder="Enter API" value="{{ old('api', $data->api) }}" />
                                            @error('api')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sae" name="sae"
                                                placeholder="Enter SAE" value="{{ old('sae', $data->sae) }}" />
                                            @error('sae')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="content" name="content"
                                                placeholder="Enter Content" value="{{ old('content', $data->content) }}" />
                                            @error('content')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="link1" name="link1"
                                                placeholder="Enter Link 1" value="{{ old('link1', $data->link1) }}" />
                                            @error('link1')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="link2" name="link2"
                                                placeholder="Enter Link 2" value="{{ old('link2', $data->link2) }}" />
                                            @error('link2')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="link3" name="link3"
                                                placeholder="Enter Link 3" value="{{ old('link3', $data->link3) }}" />
                                            @error('link3')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="link4" name="link4"
                                                placeholder="Enter Link 4" value="{{ old('link4', $data->link4) }}" />
                                            @error('link4')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($data->image1)
                                                ...
                                                <img src="{{asset('storage/product-oli/' . $data->image1)}}" width="100"
                                                    height="100" alt="">
                                            @endif
                                            @error('image1')
                                                <small>{{ $message }}</small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sni" name="sni"
                                                placeholder="Enter SNI" value="{{ old('sni', $data->sni) }}" />
                                            @error('sni')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="npt" name="npt"
                                                placeholder="Enter NPT" value="{{ old('npt', $data->npt) }}" />
                                            @error('npt')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="npb" name="npb"
                                                placeholder="Enter NPB" value="{{ old('npb', $data->npb) }}" />
                                            @error('npb')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="barcode" name="barcode"
                                                placeholder="Enter Barcode" value="{{ old('barcode', $data->barcode) }}" />
                                            @error('barcode')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
