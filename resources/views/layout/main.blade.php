...
<html lang="en">
  ...
  <body>
      ...
      <div class="sidebar" data-background-color="dark">
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="{{asset('lte/index.html')}}" class="logo">
              <img
            ...
            <ul class="nav nav-secondary">
              <li class="nav-item active">
                ...
                <div class="collapse" id="dashboard">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{asset('lte/../demo1/index.html')}}">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="base">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="{{asset('lte/components/gridsystem.html')}}">
                        <span class="sub-item">Grid System</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{asset('lte/components/panels.html')}}">
                        <span class="sub-item">Panels</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{asset('lte/components/notifications.html')}}">
                        <span class="sub-item">Notifications</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{asset('lte/components/sweetalert.html')}}">
                        <span class="sub-item">Sweet Alert</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{asset('lte/components/font-awesome-icons.html')}}">
                        <span class="sub-item">Font Awesome Icons</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{asset('lte/components/simple-line-icons.html')}}">
                        <span class="sub-item">Simple Line Icons</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{asset('lte/components/typography.html')}}">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{ asset('lte/sidebar-style-2.html')}}">
                        <span class="sub-item">Sidebar Style 2</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{ asset('lte/icon-menu.html')}}">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="forms">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{ asset('lte/forms/forms.html')}}">
    ...
    <!-- Bootstrap Notify -->
    <script src="{{asset('lte/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
    ...
    <script src="{{asset('lte/assets/js/setting-demo.js')}}"></script>
    <script src="{{asset('lte/assets/js/demo.js')}}"></script>
    <script>
